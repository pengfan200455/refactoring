...
public class StatementPrinter {
    ...
    private static final int TRAGEDY_EXTRA_PER_AUDIENCE = 1000;
    private static final int AMOUNT_PERCENT_FACTOR = 100;
    ...
    public String statement() {
        ...
        for (Performance performance : invoice.getPerformances()) {
            ...
            switch (play.getType()) {
                case "tragedy":
                    ...
                    if (performance.getAudience()
                        ...
                        thisAmount += TRAGEDY_EXTRA_PER_AUDIENCE
            ...
            result.append(String.format(
                    ...
                    play.getName(),
                    formatter.format(
                            (double) thisAmount / AMOUNT_PERCENT_FACTOR),
                    performance.getAudience()));
        ...
        result.append(String.format(
                "Amount owed is %s%n",
                formatter.format(
                        (double) totalAmount / AMOUNT_PERCENT_FACTOR)));
        result.append(String.format(
